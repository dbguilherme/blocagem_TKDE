...
//        Collections.shuffle(blocksQueue, new Random()); // random order
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        String mainDirectory = "/home/guilherme/Downloads/BlockingFramework/data/";
        String blocksPath = mainDirectory + "sets/dataset1_dblp";
        String groundTruthPath = mainDirectory + "ground/groundtruth";
