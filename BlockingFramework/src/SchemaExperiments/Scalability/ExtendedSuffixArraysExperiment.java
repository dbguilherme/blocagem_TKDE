 ...
 * @author G.A.P. II
 */
public class ExtendedSuffixArraysExperiment {
            ...
            for (int blockKeyId = 0; blockKeyId < 3; blockKeyId++) {
                ...
                for (int maxBlockSize : maxBlockSizes) {
                    for (int minSuffixLength : minSuffixLengths) {
                        ...
                        ExtendedSuffixArrays blockingMethod = new ExtendedSuffixArrays(maxBlockSize, minSuffixLength, blockingKeys[blockKeyId], ProfileType.SYNTHETIC_PROFILE, Utilities.getEntities(datasetId));
