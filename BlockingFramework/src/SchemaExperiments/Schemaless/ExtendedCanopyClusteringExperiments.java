...
import BlockBuilding.MemoryBased.ExtendedCanopyClustering;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int datasetId = 0; datasetId < 4; datasetId++) {
            ...
            for (int i = 0; i < n1.length; i++) {
                for (int q : qs) {
                    ExtendedCanopyClustering blockingMethod = new ExtendedCanopyClustering(n1[i], n2[i], q, Utilities.getEntities(datasetId));
